<%-- 
    Document   : 07crearMatricula
    Created on : 20/09/2021, 8:42:52 p. m.
    Author     : Juanfer
--%>
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 1080px; height:60px; ">
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <label class="py-2 d-none d-md-inline-block text-primary" >Crear Matricula</label>
          <a class="py-2 d-none d-md-inline-block" href="#">Borrar Matricula</a>
          <a class="py-2 d-none d-md-inline-block" href="#">Modificar Matricula</a>
  ...
  <div class="container mt-5"> 
    <h3 class="mb-3">Crear Matricula</h3>
    <hr>

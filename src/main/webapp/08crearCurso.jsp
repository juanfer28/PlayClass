<%-- 
    Document   : 08crearCurso
    Created on : 20/09/2021, 8:43:30 p. m.
    Author     : Juanfer
--%>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 1080px; height:60px; ">
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <label class="py-2 d-none d-md-inline-block text-primary" >Crear Curso</label>
          <a class="py-2 d-none d-md-inline-block" href="#">Borrar Curso</a>
          <a class="py-2 d-none d-md-inline-block" href="#">Modificar Curso</a>
